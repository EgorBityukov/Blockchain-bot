...
2. Система перебирает все ОК кошельки, которые в данный момент активны и совершает обмен всех имеющихся на кошельках токенов на USDC (исключение: SOL-токены, их Система не трогает) <br>
3. После выполнения п.2, все имеющиеся USDC-токены на балансе ОК Система переводит на ГК. <br>
